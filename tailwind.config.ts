...
export default {
	...
	theme: {
		...
		extend: {
			...
			boxShadow: {
				'gentle': '0 4px 6px -1px hsl(0 0% 0% / 0.1), 0 2px 4px -2px hsl(0 0% 0% / 0.1)',
				'warm': '0 10px 15px -3px hsl(0 0% 0% / 0.1), 0 4px 6px -4px hsl(0 0% 0% / 0.1)',
				'floating': '0 20px 25px -5px hsl(0 0% 0% / 0.1), 0 8px 10px -6px hsl(0 0% 0% / 0.1)'
			},
			borderRadius: {
				lg: 'var(--radius)',
